...
const displaySeats = ()=>{
    let selectedSeatsFromStroge = JSON.parse(localStorage.getItem("selectedSears"));

    if(selectedSeatsFromStroge !== null && selectedSeatsFromStroge.length>0){
        allSeats.forEach((seat,index)=>{
            if(selectedSeatsFromStroge.indexOf(index)>-1){
